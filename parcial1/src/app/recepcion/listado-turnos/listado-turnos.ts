...
export class ListadoTurnosComponent {
  ...
  turnos: Turno[] = [
    { idTurno: 1, fecha: this.fecha, horaInicioAgendamiento: '07:00', horaFinAgendamiento: '07:30', idProveedor: 1, idJaula: null },
    { idTurno: 2, fecha: this.fecha, horaInicioAgendamiento: '08:00', horaFinAgendamiento: '08:30', idProveedor: 2, idJaula: null }
  ];
